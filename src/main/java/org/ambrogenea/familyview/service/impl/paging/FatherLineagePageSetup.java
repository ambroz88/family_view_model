...
public class FatherLineagePageSetup implements Pageable {

    private final Paging paging;

    public FatherLineagePageSetup(ConfigurationService config) {
    ...
    private int calculatePageWidth(AncestorPerson personModel) {
        return paging.calculateFatherLineageWidth(personModel);
    }
